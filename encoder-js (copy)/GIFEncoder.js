...
GIFEncoder = function()
{
	...
	*/
	...
	exports.setDelay = function setDelay(ms/*int*/)/*void*/
	{
	...
	*/
	...
	exports.setDispose = function setDispose(code/*int*/)/*void*/ 
	{
	...
	*/
	...
	exports.setRepeat = function setRepeat(iter/*int*/)/*void*/ 
	{
	...
	*/
	...
	exports.setTransparent = function setTransparent(c/*Number*/)/*void*/
	{
	...
	*/
	...
	exports.addFrame = function addFrame(im/*BitmapData*/)/*Boolean*/
	{
	    ...
	    //try {
			...
			image = im.getImageData(0,0, im.canvas.width, im.canvas.height);//new Bitmap ( im );
			console.log(image);
	...
	*/
	...
	exports.finish = function finish()/*Boolean*/
	{
	...
	*/
	...
	exports.setFrameRate = function setFrameRate(fps/*Number*/)/*void*/ 
	{
	...
	*/
	...
	exports.setQuality = function setQuality(quality/*int*/)/*void*/
	{
	...
	*/
	...
	exports.start = function start()/*Boolean*/
	{
	...
	*/
	...
	/*private*/ function analyzePixels()/*void*/
	{
		...
		var len/*int*/ = pixels.bin.length;
	    var nPix/*int*/ = len / 3;
	    indexedPixels = new ByteArray;
	    var nq/*NeuQuant*/ = new NeuQuant(pixels.bin, len, sample);
	...
	*/
	...
	/*private*/ function getImagePixels()/*void*/
	{
	    ...
	    for ( var i/*int*/ = 0; i < h; i++ )
	    {
	    	...
	    	{
	    		var b = (i*w*4)+j*4;
	    		pixels.bin[count++] = data[b];
	    		pixels.bin[count++] = data[b+1];
	    		pixels.bin[count++] = data[b+2];
	    	}
	...
	*/
	...
	{
	    console.log('writePixels')
		
	    var myencoder/*LZWEncoder*/ = LZWEncoder(width, height, indexedPixels, colorDepth);
	...
	*/
	exports.stream = function stream ( )/*ByteArray*/
	{
